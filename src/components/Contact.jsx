...
const CONTACT_INFO = {
  ...
  email: "contact@navvkhushhelping.org",
  email2: "info@navvkhushhelping.org",
  phone: "+91 8851691233",
  mobile: "+91-8287372178",
  address: "B-108 sector 6 noida, Delhi 201301, Uttar pradesh, India",
  socials: [
    {
      href: "https://www.facebook.com/share/1CsRf5rAoS",
      label: "Facebook",
      icon: (
    ...
    {
      href: "https://www.linkedin.com/in/kavita-rawat-914669260",
      label: "Linkedin",
      icon: (
        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      href: "http://Instagram.com/navv_khush",
      label: "Instagram",
      icon: (
        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      href: "https://www.youtube.com/@Navvkhushhelpingfoundationn",
      label: "YouTube",
      icon: (
        <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
...
function Contact() {
  ...
  const getDirections = () => {
    ...
    window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent("28°35'33.2\"N 77°18'59.4\"E")}`);
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md h-96 relative flex items-center justify-center">
                {/* Google Maps Embed */}
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3503.2406018746033!2d77.31651!3d28.592557999999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjjCsDM1JzMzLjIiTiA3N8KwMTgnNTkuNCJF!5e0!3m2!1sen!2sin!4v1762769320432!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                <div className="space-y-2 text-sm text-gray-700">
                  <p>🚇 <strong>Metro:</strong> sector 15 (nearest station)</p>
