    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "A hungry child cannot concentrate in class. Malnutrition is one of the biggest barriers to education in India, as children fall sick or lack the energy to study.",
            "We connect nutrition with education by organizing regular health check-ups in schools, where doctors monitor children’s growth and provide necessary treatment. Awareness programs are also conducted to guide parents on providing balanced meals. ",
            "In many cases, schools become the best place to ensure children receive at least one healthy meal a day.",
            ". Healthy children learn better, play better, and grow better – which is why nutrition is an integral part of our education programs.",
