    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Education should prepare children for life, not just exams. Skill-based learning equips children with practical knowledge and abilities that will help them in their careers and daily lives.",
            "We provide vocational training in areas like tailoring, handicrafts, basic electronics, and art for older children and teenagers. This ensures they can generate income or pursue self-employment in the future.",
            "For school-going children, we conduct career counseling sessions to guide them in choosing their educational and career paths based on their interests and strengths.",
            "Additionally, we emphasize soft skills such as communication, teamwork, leadership, and problem-solving – qualities that are essential in any profession. Skill-based education ensures children are ready for real-world challenges.",
