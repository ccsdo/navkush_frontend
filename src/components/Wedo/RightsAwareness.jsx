    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Awareness is the first step to empowerment. Many parents and children do not know that education is a legal right under the Right to Education (RTE) Act in India.",
            "We organize community sessions to educate families about RTE and how they can use it to ensure free and compulsory schooling for their children.",
            "Our campaigns also focus on preventing child labour, explaining how education is the strongest tool to break the cycle of poverty.",
            "We also hold parents’ workshops to make them realize that schooling is not a burden but an investment in their child’s future. When parents and communities value education, children are more likely to stay in school and succeed.",
          ].map((item) => (
