    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Access alone is not enough; children must receive quality education that encourages curiosity, critical thinking, and creativity. Poor teaching methods, lack of resources, and overcrowded classrooms often leave children unable to truly learn.",
            "To improve quality, we provide teacher training sessions so that educators use child-friendly and activity-based teaching methods.",
            "We supply learning materials such as textbooks, stationery, storybooks, and even digital tools that make learning interactive.",
            "Additionally, we introduce English language and communication programs to help children build confidence, especially since English often opens more career opportunities in the future.",
            "Quality education ensures that children not only attend school but also benefit from it in meaningful ways.",
          ].map((item) => (
