    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Many children in India remain out of school due to poverty, lack of awareness, child labour, or migration. Access to education means ensuring that every child, regardless of their background, gets a chance to sit in a classroom and learn.",
            "We conduct school enrollment drives to identify out-of-school children and connect them with nearby schools.",
            "For those who have dropped out, we run bridge courses that help them catch up with the syllabus and rejoin formal education. ",
            "We also carry out re-enrollment campaigns in communities to encourage parents to send their children back to school.",
            "To support working children or those who cannot attend school regularly, we organize free evening classes that provide extra learning support. Our vision is that no child should miss education because of circumstances beyond their control.",
          ].map((item) => (
