    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "The first six years of a child’s life are the most important for brain development. Unfortunately, this stage is often ignored, especially in underprivileged communities.",
            "Early childhood education lays the foundation for language, social skills, and cognitive growth.",
            "We support Anganwadi centers and help strengthen their pre-school education programs. Our focus is on activity-based learning for children aged 3–6 years, which includes storytelling, drawing, games, and interactive exercises that make learning joyful.",
            "We also work with parents, conducting parental guidance workshops to teach them how to support their child’s early development at home. A strong start in early education helps children transition smoothly into school and reduces dropout rates later.",
          ].map((item) => (
