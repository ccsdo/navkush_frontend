    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "The world is moving fast with technology, but millions of children in rural and low-income communities remain disconnected from digital learning. In today’s age, digital literacy is as essential as reading and writing.",
            "We organize computer literacy programs where children learn basic computer operations, typing, and software skills.",
            "In rural schools, we introduce smart classrooms with digital boards, projectors, and e-learning content that make education more engaging.",
            "Children are also guided on safe internet usage, ensuring they learn to use technology responsibly.",
            "Additionally, we conduct e-learning workshops using mobile apps and online resources, so that learning is not restricted to classrooms. This prepares children for a future where digital knowledge will be the key to opportunities.",
          ].map((item) => (
