    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Every child has a voice, and that voice deserves to be heard. The right to participation ensures that children can express their opinions freely in matters that affect their lives.",
            "Whether in the family, school, or community, their thoughts and choices must be respected.",
            "This right empowers children to become active members of society, teaching them responsibility, confidence, and the importance of democracy from an early age.",
