    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Good health is essential for a child’s development. This right guarantees access to hospitals, medical care, vaccinations, clean drinking water, and nutritious food.",
            "A healthy child can concentrate better in school, play actively, and grow mentally and physically strong.",
            "Denying health and nutrition means denying children the chance to live a wholesome life and achieve their true potential.",
