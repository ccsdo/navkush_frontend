    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Every child has the fundamental right to live and grow with dignity. ",
            "This right ensures that children have access to the most basic needs such as nutritious food, clean drinking water, proper healthcare, and shelter.",
            "Without survival rights, children cannot achieve their full potential. A safe start in life lays the foundation for a bright and healthy future, where no child is left behind due to poverty or neglect.",
