    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Children are the future of our nation, and it is our responsibility to ensure that they grow up in a safe, healthy, and supportive environment.",
            "Child Rights are those special rights that guarantee every child protection, care, education, and dignity, regardless of their background.",
            "These rights are recognized globally under the United Nations Convention on the Rights of the Child (UNCRC) and are also safeguarded by the Indian Constitution.",
            "At Navvkhush Helping Foundation, we strongly believe in protecting and promoting these rights so that every child gets an equal chance to shine.",
