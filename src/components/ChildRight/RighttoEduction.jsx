    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Education is the pathway to empowerment and opportunity.",
            "Under the Right to Education Act in India, every child between the ages of 6 to 14 years is entitled to free and compulsory education. This right not only gives children access to schools and teachers but also ensures quality learning that helps them become confident, independent, and capable individuals.",
            "Education breaks the cycle of poverty and opens doors to endless possibilities.",
