    ...
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-6 lg:py-8 bg-white/95 backdrop-blur rounded-3xl shadow-2xl border border-slate-200 flex flex-col items-center text-center">
        ...
        <ul className="mt-10 space-y-6 text-slate-800 text-lg w-full max-w-3xl">
          {[
            "Children are vulnerable and must be safeguarded from all forms of violence, exploitation, abuse, and neglect.",
            "The right to protection ensures that children are safe both within and outside their homes, whether at school, in their communities, or in the workplace.",
            "Protecting children means giving them an environment where they can grow without fear, trauma, or harm, ensuring a childhood full of love, care, and security.",
